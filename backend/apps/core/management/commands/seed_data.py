...
class Command(BaseCommand):
    ...
    def _seed_locations(self, practice):
        ...
        location_pucon, created = Location.objects.get_or_create(
            ...
            defaults={
                "name": "Sede Pucón",
                "address": "O'Higgins 211, Pucón",
                "city": "Pucón",
                "region": "Araucanía",
                "phone": "+56 45 244 3100",
                "email": "pucon@estefipediatra.com",
                "latitude": Decimal("-39.2823000"),
                "longitude": Decimal("-71.9543000"),
        ...
        location_villarrica, created = Location.objects.get_or_create(
            ...
            slug="villarrica",
            defaults={
                "name": "Sede Villarrica",
                "address": "Camilo Henríquez 576, Villarrica",
                "city": "Villarrica",
                "region": "Araucanía",
                "phone": "+56 45 241 2200",
                "email": "villarrica@estefipediatra.com",
                "latitude": Decimal("-39.2686000"),
                "longitude": Decimal("-72.2271000"),
