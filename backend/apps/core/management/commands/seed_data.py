    ...
    def _seed_appointments(self, practice, doctor, tutor1, patient1, patient2, location_pucon, location_villarrica, services):
        ...
        appointments_data = [
            ...
            },
            {
                ...
                "booked_by": tutor1,
                "scheduled_date": today,
                "start_time": datetime.time(15, 45),
            ...
            },
            {
                ...
                "status": Appointment.CONFIRMED,
                "is_online": False,
                "notes": "Reservado como nuevo paciente — pendiente cargar ficha clínica.",
            },
            # ── Tomorrow's appointments ──────────────────────────────────
            {
                ...
                "status": Appointment.CONFIRMED,
                "is_online": False,
                "notes": "Control seguimiento otitis. Evaluar evolución.",
            },
            {
                "patient": patient2,
                "service": control_sano,
                ...
                "status": Appointment.CONFIRMED,
                "is_online": False,
                "notes": "Control 10 meses. Evaluar desarrollo y alimentación.",
            },
