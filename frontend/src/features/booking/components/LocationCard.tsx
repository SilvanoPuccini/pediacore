...
type LocationOption = Location | { id: "online"; name: string; address: string; city: string; slug?: string };
...
function LocationIcon({ location, isSelected }: { location: LocationOption; isSelected: boolean }) {
  if (location.id === "online") {
    return (
      <div
        className={[
          "w-11 h-11 rounded-[10px] flex items-center justify-center flex-shrink-0 mt-0.5",
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <LocationIcon location={location} isSelected={isSelected} />
        <div>
